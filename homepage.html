                ...
                <div class="containeer">
                    ...
                    <nav class="m-nav">
                        ...
                        <ul class="nav-l">
                            ...
                            <li class="nav-l-i">
                                <a href="Promotions.html" class="link" target="_blank">Promotions</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="Products/Products.html" class="link" target="_blank">E-Shopping</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="fundingprograms.html" class="link" target="_blank">Funding</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="Kontakti.html" class="link" target="_blank">Contact Us</a>
                            </li>

    ...
    <head>
            ...
            <header>
                <div class="containeer">
                    ...
                    <nav class="m-nav">
                        ...
                        <ul class="nav-l">
                            <li class="nav-l-i">
                                <a href="Home" class="link" style="margin-left:140px;">Home</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="Home" class="link">Promotions</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="Home" class="link">E-Shopping</a>
                            </li>
                            <li class="nav-l-i">
                                <a href="Home" class="link">Funding</a>
                            </li>
                            <li class="nav-l-i">
        ...
        <div class="begin">
            ...
            <div class="header-text">
                <div class="teksti" style="font-family:'Poppins', sans-serif; font-size: 25px; font-weight: normal;">Let us enhance your sales</div>
            </div>
        </div>
        <svg class="wave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,96L120,85.3C240,75,480,53,720,53.3C960,53,1200,75,1320,85.3L1440,96L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
            </div>
        </section>
        ...
        <div class="hyrja"> <div class="hyrja-scroll" style="font-size: 16px;">
        ...
        <section class="section3">
            <svg class="svg-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#fff" fill-opacity="1" d="M0,64L120,80C240,96,480,128,720,138.7C960,149,1200,139,1320,133.3L1440,128L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path></svg>
                ...
                <p>
                    <ol style="list-style-type: none;">
                        <li style="font-size:20px;">As a Kosovo's business promotion agency,
                            <abbr title="Business Promotion Agency">BPA</abbr> works together as one firm to serve our clients
                ...
                <div class="w-text3">
                    ...
                    <p>
                        <ol style="list-style-type: none;">
                            ...
                            and other projects, we assist and protect the interests of small businesses' concerns, to maintain
                        and strengthen the overall economy of our nation.</li>
                        </ol>
                    </p>
                </div>
                <div class="w-white">
            ...
            <div class="d-section4" >
                ...
                <div class="area" style="position: relative; z-index: 400;">
                    <table class="ta2">
                        ...
                        <tr>
                        <td style="border-right:3px solid black"><img src="images/portfolio.png" alt="Bag Pic" style="width: 30px; height: 30px;"><br/>
                        <p style="color:black; font-size:20px;">Projects</p>
                        <p style="font-size: 60px; color:black; font-weight: bold; font-family: 'Rajdhani', sans-serif;">56</p>
                        </td>
                        <td style="border-right:3px solid black; padding-right: 20px; padding-left:20px;"><img src="images/mouse.png" alt="Mouse Pic" style="width: 40px; height:40px;"><br/>
                        <p style="color:black; font-size:20px;">Working Days</p>
                        <p  style="font-size: 60px; color:black; font-weight: bold; font-family: 'Rajdhani', sans-serif;">312</p>
                        </td>
                        <td><img src="images/customer.png" alt="Costumer Pic" style="width: 40px; height:40px;"><br/>
                            ...
                            <p style="font-size: 60px; color:black; font-weight: bold; font-family: 'Rajdhani', sans-serif;">68</p>
                        </td>
                        </tr>
                        </table>
                </div>
        ...
        <section class="permultiplec">
            “The team at BPA are great listeners,they understood exactly what I was trying to achieve and I can’t praise their attention to detail highly enough. Nothing was too much trouble and I was delighted with the wonderful outcome of my advertising campaign.”
                        ...
                        <div class="client-s">
                            <h3>Gresë Kuçi</h3>
                            <span>Founder at Gikio</span>
                        </div>
                        </div>
                        <div class="slide">
                            <p>“Always a pleasure to work with BPA. Such professional and happy people and you know you’ll receive a quick, innovative and no fuss service.”</p>
                        <div class="client-s">
                            <h3>Tea Marleku</h3>
                            <span>Founder at KrimSim</span>
                        </div>
                        </div>
                        <div class="slide">
            ...
            <div class="team-section" style="display:none;" id="team">
                <div class="inner-team">
                    ...
                    <div class="m-name">Full Name</div>
                    <div class="m-position"><i>Designer</i></div>
                    <div class="m-social">
                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                        <a href="#"><i class="fab fa-twitter"></i></a>
                        <a href="#" id=""><i class="fab fa-instagram"></i></a>
                    </div>
                    </div>
            ...
            <!-- <div class="datas">
                ...
                <div class="data-box">
                    <div class="ikone">
                        ...
                        <h4>Address</h4>
                        <h4>Bregu i Diellit, Prishtinë</h4>
                    </div>
                    <div class="data-box">
                        <div class="ikone">
